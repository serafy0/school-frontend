<template>
  <div>
        ...
        <div class="box">
          <form @submit.prevent="addCourse">
            ...
            <b-field label="course name">
              <b-input v-model="course.name" maxlength="255" has-counter="false" required>
              </b-input>
            </b-field>

            <b-field label="description">
              <b-input v-model="course.description" type="textarea" required maxlength="255">
              </b-input>
            </b-field>
    ...
    <section v-if="$auth.user && $auth.user.role === 'TEACHER'" class="columns is-multiline mt-0">
      <div
        v-for="(course, index) in courses"
        ref="courses"
        :key="index"
        class="column is-half is-desktop pt-3"
      >
        <div class="card has-text-weight-bold">
          ...
          <div class="card-content has-background-grey-light is-size-5">
            <div class="content" style="word-wrap: break-word">
              ...
              <p class="is-size-6 has-text-right has-text-grey-dark">
